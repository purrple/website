...
I also had a few contacts, this materialised to few consulting gigs. And anyway, the worst come the worst 
...
This lasted 8 years, and let's just say it has not been the best financial journey, I was structureless, 
...
travelled to many places again, but for the most part, let's be real for a minute,
when you do consulting, most of the time, not only you work on projects you don't choose,
...
the `r emo::ji("package")` but the jni inspired low level was a bit daunting.  

I discovered Google's 
[protocol buffers]()
