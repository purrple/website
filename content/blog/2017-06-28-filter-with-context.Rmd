...
Hadley said that he does not yet really know how to teach tidyeval. I don't pretend I have ot covered, but here's an example
...
Things happen as if we used this expression: 

```{r, eval=FALSE}
slice( mtcars, context(which(cyl == 4), n(), before = 1, after = 1) )
```

But letting R do the copy and paste for us. 
